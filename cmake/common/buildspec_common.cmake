...
function(_setup_obs_studio)
  ...
  if(OS_WINDOWS)
    ...
    set(
      _cmake_extra
      "-DCMAKE_SYSTEM_VERSION=${CMAKE_SYSTEM_VERSION} -DCMAKE_ENABLE_SCRIPTING=OFF -DENABLE_BROWSER=OFF -DENABLE_VIRTUALCAM=OFF -DENABLE_AJA=OFF -DENABLE_DECKLINK=OFF -DENABLE_VLC=OFF"
    )
  elseif(OS_MACOS)
